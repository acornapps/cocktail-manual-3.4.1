...
![EKS-NAT-Gateway]({{ site.baseurl }}/assets/ZH/{{ site.version }}/EKS/eks-nat-gateway.png)  
...
### 6. Worker Node 조인 한다.
  ...
  * [Quick Start 문서 참조](https://acornapps.github.io/cocktail-manual-3.1.1/docs/zh/8.1.1.5/)
