...
Kubernetesクラスタに認証するためにAWS IAMの資格情報を使用しているツールです。
...
또는 go get 을 사용하여 GitHub의 [Kubernetes用AWS IAM Authenticator] (https://github.com/kubernetes-sigs/aws-iam-authenticator) 프로젝트에서 다른 운영 체제용 바이너리를 가져올 수 있다.
...
---
### 5. 2단계: Amazon EKS Work node 起動および設定
