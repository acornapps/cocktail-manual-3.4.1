...
### a\) 서비스에서 카탈로그로 저장하는 어플리케이션 맵을 선택![]({{ site.baseurl }}/assets/KR/{{ site.version }}/4.1_1.png)

### b\) 화면 우측 상단 카탈로그로 저장' 버튼을 클릭![]({{ site.baseurl }}/assets/KR/{{ site.version }}/4.1_2.png)
...
![]({{ site.baseurl }}/assets/KR/{{ site.version }}/4.1_3.png)
